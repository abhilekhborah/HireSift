...
class InterviewScheduler:
    def __init__(self, interviewers=None):
        ...
        self.email_templates = {
            "default": """
Subject: Interview Invitation: {role_type} Position - {formatted_date}

Dear {candidate_name},

We are pleased to invite you to an interview for the {role_type} position at our company. After reviewing your impressive qualifications and experience, we believe you would be a valuable addition to our team.{skills_section}
...
During the interview, we'll discuss your technical experience, problem-solving approach, and how your skills align with our development needs. Please be prepared to discuss your past projects and specific experiences with {role_type} development.

Technical Preparation:
We recommend having a quiet environment and a stable internet connection for the interview. You might want to prepare examples of your work in areas such as:
- Front-end development (HTML/CSS/JavaScript frameworks)
- Back-end development (APIs, databases, server-side languages)
